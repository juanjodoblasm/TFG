...
#### Ajuste del modelo para enfermedades del sistema nervioso
...
y el p-valor $P(D_0 \ge 440.2696)$ (con $D_0 \sim \chi^2(1331)$) es
...
y el p-valor $P(D_1 \ge 439.9582)$ (con $D_1 \sim \chi^2(1330)$) es
...
y el p-valor $P(\Delta D \ge 0.3114133)$ (con $\Delta D \sim \chi^2(1)$) es
...
```{r}
residuales = m_enf_sist_nervioso2$residuals
residuales
```
...
#### Ajuste del modelo para enfermedades del sistema digestivo
...
#### Ajuste del modelo para trastornos del embarazo
